"""Command-line smoke test for the V1.1 Hybrid Retriever."""
...
def main() -> None:
    ...
    print(f"Top {len(results)} Hybrid RRF results:")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="使用 Dense + BM25 执行 V1.1 Hybrid RRF Retrieval。")
    ...
    parser.add_argument("--dense-collection", help="Dense collection，默认读取 MILVUS_COLLECTION")
    parser.add_argument(
        "--bm25-collection",
